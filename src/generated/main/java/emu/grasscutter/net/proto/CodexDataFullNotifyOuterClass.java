...
public final class CodexDataFullNotifyOuterClass {
  ...
  public interface CodexDataFullNotifyOrBuilder extends
    ...
    /**
     * <code>repeated uint32 IGMFFAGOCIA = 11;</code>
     * @return A list containing the iGMFFAGOCIA.
     */
    java.util.List<java.lang.Integer> getIGMFFAGOCIAList();
    /**
     * <code>repeated uint32 IGMFFAGOCIA = 11;</code>
     * @return The count of iGMFFAGOCIA.
     */
    int getIGMFFAGOCIACount();
    /**
     * <code>repeated uint32 IGMFFAGOCIA = 11;</code>
     * @param index The index of the element to return.
     * @return The iGMFFAGOCIA at the given index.
     */
    int getIGMFFAGOCIA(int index);

    /**
     * <code>uint32 BIFMJKDHHLG = 8;</code>
     * @return The bIFMJKDHHLG.
     */
    int getBIFMJKDHHLG();

    /**
     * <code>uint32 AEHJDIPOLHC = 10;</code>
     * @return The aEHJDIPOLHC.
     */
    int getAEHJDIPOLHC();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 64: {
              ...
              bIFMJKDHHLG_ = input.readUInt32();
              break;
            }
            case 80: {

              aEHJDIPOLHC_ = input.readUInt32();
              break;
            }
            case 88: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                iGMFFAGOCIA_ = newIntList();
                mutable_bitField0_ |= 0x00000002;
              }
              iGMFFAGOCIA_.addInt(input.readUInt32());
              break;
            }
            case 90: {
    ...
    public static final int IGMFFAGOCIA_FIELD_NUMBER = 11;
    private com.google.protobuf.Internal.IntList iGMFFAGOCIA_;
    /**
     * <code>repeated uint32 IGMFFAGOCIA = 11;</code>
     * @return A list containing the iGMFFAGOCIA.
     */
     ...
     * @return The count of iGMFFAGOCIA.
     */
    public int getIGMFFAGOCIACount() {
      return iGMFFAGOCIA_.size();
    }
    /**
     * <code>repeated uint32 IGMFFAGOCIA = 11;</code>
     * @param index The index of the element to return.
     * @return The iGMFFAGOCIA at the given index.
     */
    public int getIGMFFAGOCIA(int index) {
      return iGMFFAGOCIA_.getInt(index);
    }
    private int iGMFFAGOCIAMemoizedSerializedSize = -1;

    public static final int BIFMJKDHHLG_FIELD_NUMBER = 8;
    private int bIFMJKDHHLG_;
    /**
     * <code>uint32 BIFMJKDHHLG = 8;</code>
     * @return The bIFMJKDHHLG.
     */
    @java.lang.Override
    public int getBIFMJKDHHLG() {
      return bIFMJKDHHLG_;
    }

    public static final int AEHJDIPOLHC_FIELD_NUMBER = 10;
    private int aEHJDIPOLHC_;
    /**
     * <code>uint32 AEHJDIPOLHC = 10;</code>
     * @return The aEHJDIPOLHC.
     */
    @java.lang.Override
    public int getAEHJDIPOLHC() {
      return aEHJDIPOLHC_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (bIFMJKDHHLG_ != 0) {
        output.writeUInt32(8, bIFMJKDHHLG_);
      }
      if (aEHJDIPOLHC_ != 0) {
        output.writeUInt32(10, aEHJDIPOLHC_);
      }
      if (getIGMFFAGOCIAList().size() > 0) {
        output.writeUInt32NoTag(90);
        output.writeUInt32NoTag(iGMFFAGOCIAMemoizedSerializedSize);
      }
      for (int i = 0; i < iGMFFAGOCIA_.size(); i++) {
        output.writeUInt32NoTag(iGMFFAGOCIA_.getInt(i));
      }
    ...
    public int getSerializedSize() {
      ...
      if (bIFMJKDHHLG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, bIFMJKDHHLG_);
      }
      if (aEHJDIPOLHC_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, aEHJDIPOLHC_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < iGMFFAGOCIA_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(iGMFFAGOCIA_.getInt(i));
        }
        size += dataSize;
        if (!getIGMFFAGOCIAList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        iGMFFAGOCIAMemoizedSerializedSize = dataSize;
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getIGMFFAGOCIAList()
          .equals(other.getIGMFFAGOCIAList())) return false;
      if (getBIFMJKDHHLG()
          != other.getBIFMJKDHHLG()) return false;
      if (getAEHJDIPOLHC()
          != other.getAEHJDIPOLHC()) return false;
    ...
    public int hashCode() {
      ...
      if (getIGMFFAGOCIACount() > 0) {
        hash = (37 * hash) + IGMFFAGOCIA_FIELD_NUMBER;
        hash = (53 * hash) + getIGMFFAGOCIAList().hashCode();
      }
      hash = (37 * hash) + BIFMJKDHHLG_FIELD_NUMBER;
      hash = (53 * hash) + getBIFMJKDHHLG();
      hash = (37 * hash) + AEHJDIPOLHC_FIELD_NUMBER;
      hash = (53 * hash) + getAEHJDIPOLHC();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify buildPartial() {
        ...
        if (((bitField0_ & 0x00000002) != 0)) {
          iGMFFAGOCIA_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000002);
        }
        result.iGMFFAGOCIA_ = iGMFFAGOCIA_;
        result.bIFMJKDHHLG_ = bIFMJKDHHLG_;
        result.aEHJDIPOLHC_ = aEHJDIPOLHC_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.CodexDataFullNotifyOuterClass.CodexDataFullNotify other) {
        ...
        if (!other.iGMFFAGOCIA_.isEmpty()) {
          if (iGMFFAGOCIA_.isEmpty()) {
            iGMFFAGOCIA_ = other.iGMFFAGOCIA_;
            bitField0_ = (bitField0_ & ~0x00000002);
          } else {
            ensureIGMFFAGOCIAIsMutable();
            iGMFFAGOCIA_.addAll(other.iGMFFAGOCIA_);
          }
          onChanged();
        }
        if (other.getBIFMJKDHHLG() != 0) {
          setBIFMJKDHHLG(other.getBIFMJKDHHLG());
        }
        if (other.getAEHJDIPOLHC() != 0) {
          setAEHJDIPOLHC(other.getAEHJDIPOLHC());
        }
      ...
      private com.google.protobuf.Internal.IntList iGMFFAGOCIA_ = emptyIntList();
      private void ensureIGMFFAGOCIAIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          iGMFFAGOCIA_ = mutableCopy(iGMFFAGOCIA_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000002) != 0) ?
                 java.util.Collections.unmodifiableList(iGMFFAGOCIA_) : iGMFFAGOCIA_;
      }
      /**
       * <code>repeated uint32 IGMFFAGOCIA = 11;</code>
       * @return The count of iGMFFAGOCIA.
       ...
       * @param value The iGMFFAGOCIA to set.
       * @return This builder for chaining.
       */
      public Builder setIGMFFAGOCIA(
          int index, int value) {
        ensureIGMFFAGOCIAIsMutable();
        iGMFFAGOCIA_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 IGMFFAGOCIA = 11;</code>
       * @param value The iGMFFAGOCIA to add.
       * @return This builder for chaining.
       */
      public Builder addIGMFFAGOCIA(int value) {
        ensureIGMFFAGOCIAIsMutable();
        iGMFFAGOCIA_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 IGMFFAGOCIA = 11;</code>
       * @param values The iGMFFAGOCIA to add.
       * @return This builder for chaining.
       */
      public Builder addAllIGMFFAGOCIA(
       ...
       * @return This builder for chaining.
       */
      public Builder clearIGMFFAGOCIA() {
        iGMFFAGOCIA_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000002);
        onChanged();
        return this;
      ...
      /**
       * <code>uint32 BIFMJKDHHLG = 8;</code>
       * @param value The bIFMJKDHHLG to set.
       * @return This builder for chaining.
       */
      public Builder setBIFMJKDHHLG(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearBIFMJKDHHLG() {
      ...
      /**
       * <code>uint32 AEHJDIPOLHC = 10;</code>
       * @param value The aEHJDIPOLHC to set.
       * @return This builder for chaining.
       */
      public Builder setAEHJDIPOLHC(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearAEHJDIPOLHC() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "data_list\030\005 \003(\0132\016.CodexTypeData\022\023\n\013IGMFF" +
      "AGOCIA\030\013 \003(\r\022\023\n\013BIFMJKDHHLG\030\010 \001(\r\022\023\n\013AEH" +
    ...
    internal_static_CodexDataFullNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_CodexDataFullNotify_descriptor,
        new java.lang.String[] { "TypeDataList", "IGMFFAGOCIA", "BIFMJKDHHLG", "AEHJDIPOLHC", });
    emu.grasscutter.net.proto.CodexTypeDataOuterClass.getDescriptor();
  }
