...
public final class DoGachaRspOuterClass {
  ...
  public interface DoGachaRspOrBuilder extends
    ...
    /**
     * <code>uint32 NKJOBOABFOJ = 1679;</code>
     * @return The nKJOBOABFOJ.
     */
    int getNKJOBOABFOJ();

    /**
     * <code>bool PODALHILIKF = 1561;</code>
     * @return The pODALHILIKF.
     */
    boolean getPODALHILIKF();
  }
  /**
   * <pre>
   * CmdId: 1537
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 12488: {
              ...
              pODALHILIKF_ = input.readBool();
              break;
            }
            case 13432: {

              nKJOBOABFOJ_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int NKJOBOABFOJ_FIELD_NUMBER = 1679;
    private int nKJOBOABFOJ_;
    /**
     * <code>uint32 NKJOBOABFOJ = 1679;</code>
     * @return The nKJOBOABFOJ.
     */
    @java.lang.Override
    public int getNKJOBOABFOJ() {
      return nKJOBOABFOJ_;
    }

    public static final int PODALHILIKF_FIELD_NUMBER = 1561;
    private boolean pODALHILIKF_;
    /**
     * <code>bool PODALHILIKF = 1561;</code>
     * @return The pODALHILIKF.
     */
    @java.lang.Override
    public boolean getPODALHILIKF() {
      return pODALHILIKF_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (pODALHILIKF_ != false) {
        output.writeBool(1561, pODALHILIKF_);
      }
      if (nKJOBOABFOJ_ != 0) {
        output.writeUInt32(1679, nKJOBOABFOJ_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (pODALHILIKF_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(1561, pODALHILIKF_);
      }
      if (nKJOBOABFOJ_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1679, nKJOBOABFOJ_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getNKJOBOABFOJ()
          != other.getNKJOBOABFOJ()) return false;
      if (getPODALHILIKF()
          != other.getPODALHILIKF()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + NKJOBOABFOJ_FIELD_NUMBER;
      hash = (53 * hash) + getNKJOBOABFOJ();
      hash = (37 * hash) + PODALHILIKF_FIELD_NUMBER;
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.DoGachaRspOuterClass.DoGachaRsp buildPartial() {
        ...
        result.nKJOBOABFOJ_ = nKJOBOABFOJ_;
        result.pODALHILIKF_ = pODALHILIKF_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.DoGachaRspOuterClass.DoGachaRsp other) {
        ...
        if (other.getNKJOBOABFOJ() != 0) {
          setNKJOBOABFOJ(other.getNKJOBOABFOJ());
        }
        if (other.getPODALHILIKF() != false) {
          setPODALHILIKF(other.getPODALHILIKF());
        }
      ...
      /**
       * <code>uint32 NKJOBOABFOJ = 1679;</code>
       * @param value The nKJOBOABFOJ to set.
       * @return This builder for chaining.
       */
      public Builder setNKJOBOABFOJ(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearNKJOBOABFOJ() {
      ...
      /**
       * <code>bool PODALHILIKF = 1561;</code>
       * @param value The pODALHILIKF to set.
       * @return This builder for chaining.
       */
      public Builder setPODALHILIKF(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearPODALHILIKF() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\020DoGachaRsp.proto\032\017GachaItem.proto\"\253\003\n\n" +
      ...
      "sh_max_progress\030\014 \001(\r\022\024\n\013NKJOBOABFOJ\030\217\r " +
      "\001(\r\022\024\n\013PODALHILIKF\030\231\014 \001(\010B\033\n\031emu.grasscu" +
    ...
    internal_static_DoGachaRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_DoGachaRsp_descriptor,
        new java.lang.String[] { "Retcode", "GachaType", "GachaTimes", "GachaScheduleId", "GachaItemList", "NewGachaRandom", "CostItemId", "CostItemNum", "TenCostItemId", "TenCostItemNum", "LeftGachaTimes", "GachaTimesLimit", "WishItemId", "WishProgress", "WishMaxProgress", "NKJOBOABFOJ", "PODALHILIKF", });
    emu.grasscutter.net.proto.GachaItemOuterClass.getDescriptor();
  }
