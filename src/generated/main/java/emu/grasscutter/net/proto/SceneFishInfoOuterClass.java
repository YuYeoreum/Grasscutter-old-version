...
public final class SceneFishInfoOuterClass {
  ...
  public interface SceneFishInfoOrBuilder extends
    ...
    /**
     * <code>uint32 LPNFLHKPHEC = 5;</code>
     * @return The lPNFLHKPHEC.
     */
    int getLPNFLHKPHEC();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int LPNFLHKPHEC_FIELD_NUMBER = 5;
    private int lPNFLHKPHEC_;
    /**
     * <code>uint32 LPNFLHKPHEC = 5;</code>
     * @return The lPNFLHKPHEC.
     */
    @java.lang.Override
    public int getLPNFLHKPHEC() {
      return lPNFLHKPHEC_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (lPNFLHKPHEC_ != 0) {
        output.writeUInt32(5, lPNFLHKPHEC_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (lPNFLHKPHEC_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, lPNFLHKPHEC_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getLPNFLHKPHEC()
          != other.getLPNFLHKPHEC()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + LPNFLHKPHEC_FIELD_NUMBER;
      hash = (53 * hash) + getLPNFLHKPHEC();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo buildPartial() {
        ...
        result.lPNFLHKPHEC_ = lPNFLHKPHEC_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SceneFishInfoOuterClass.SceneFishInfo other) {
        ...
        if (other.getLPNFLHKPHEC() != 0) {
          setLPNFLHKPHEC(other.getLPNFLHKPHEC());
        }
      ...
      /**
       * <code>uint32 LPNFLHKPHEC = 5;</code>
       * @param value The lPNFLHKPHEC to set.
       * @return This builder for chaining.
       */
      public Builder setLPNFLHKPHEC(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearLPNFLHKPHEC() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\023SceneFishInfo.proto\032\014Vector.proto\"\217\001\n\r" +
      ...
      "\022\023\n\013LPNFLHKPHEC\030\005 \001(\rB\033\n\031emu.grasscutter" +
    ...
    internal_static_SceneFishInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SceneFishInfo_descriptor,
        new java.lang.String[] { "FishId", "FishPoolEntityId", "FishPoolPos", "FishPoolGadgetId", "LPNFLHKPHEC", });
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
