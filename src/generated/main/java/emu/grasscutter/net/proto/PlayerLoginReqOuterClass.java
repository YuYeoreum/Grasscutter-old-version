...
public final class PlayerLoginReqOuterClass {
  ...
  public interface PlayerLoginReqOrBuilder extends
    ...
    /**
     * <code>string MADLMMNJICA = 135;</code>
     * @return The mADLMMNJICA.
     */
    java.lang.String getMADLMMNJICA();
    /**
     * <code>string MADLMMNJICA = 135;</code>
     * @return The bytes for mADLMMNJICA.
     */
    com.google.protobuf.ByteString
        getMADLMMNJICABytes();

    /**
     * <code>string CCLJBEJHFOP = 745;</code>
     * @return The cCLJBEJHFOP.
     */
    java.lang.String getCCLJBEJHFOP();
    /**
     * <code>string CCLJBEJHFOP = 745;</code>
     * @return The bytes for cCLJBEJHFOP.
     */
    com.google.protobuf.ByteString
        getCCLJBEJHFOPBytes();

    /**
     * <code>uint32 LKCFGDBHHIL = 1881;</code>
     * @return The lKCFGDBHHIL.
     */
    int getLKCFGDBHHIL();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int MADLMMNJICA_FIELD_NUMBER = 135;
    private volatile java.lang.Object mADLMMNJICA_;
    /**
     * <code>string MADLMMNJICA = 135;</code>
     * @return The mADLMMNJICA.
     */
    @java.lang.Override
    public java.lang.String getMADLMMNJICA() {
      java.lang.Object ref = mADLMMNJICA_;
      if (ref instanceof java.lang.String) {
        return (java.lang.String) ref;
      } else {
        com.google.protobuf.ByteString bs = 
    ...
    public static final int CCLJBEJHFOP_FIELD_NUMBER = 745;
    private volatile java.lang.Object cCLJBEJHFOP_;
    /**
     * <code>string CCLJBEJHFOP = 745;</code>
     * @return The cCLJBEJHFOP.
     */
    @java.lang.Override
    public java.lang.String getCCLJBEJHFOP() {
      java.lang.Object ref = cCLJBEJHFOP_;
      if (ref instanceof java.lang.String) {
        return (java.lang.String) ref;
      } else {
        com.google.protobuf.ByteString bs = 
    ...
    public static final int LKCFGDBHHIL_FIELD_NUMBER = 1881;
    private int lKCFGDBHHIL_;
    /**
     * <code>uint32 LKCFGDBHHIL = 1881;</code>
     * @return The lKCFGDBHHIL.
     */
    @java.lang.Override
    public int getLKCFGDBHHIL() {
      return lKCFGDBHHIL_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(mADLMMNJICA_)) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 135, mADLMMNJICA_);
      }
      if (regPlatform_ != 0) {
      ...
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(cCLJBEJHFOP_)) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 745, cCLJBEJHFOP_);
      }
      ...
      if (lKCFGDBHHIL_ != 0) {
        output.writeUInt32(1881, lKCFGDBHHIL_);
      }
      if (trackingIoInfo_ != null) {
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(mADLMMNJICA_)) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(135, mADLMMNJICA_);
      }
      if (regPlatform_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(cCLJBEJHFOP_)) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(745, cCLJBEJHFOP_);
      }
      if (!extraBinData_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (lKCFGDBHHIL_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1881, lKCFGDBHHIL_);
      }
      if (trackingIoInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getMADLMMNJICA()
          .equals(other.getMADLMMNJICA())) return false;
      if (!getCCLJBEJHFOP()
          .equals(other.getCCLJBEJHFOP())) return false;
      if (getLKCFGDBHHIL()
          != other.getLKCFGDBHHIL()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + MADLMMNJICA_FIELD_NUMBER;
      hash = (53 * hash) + getMADLMMNJICA().hashCode();
      hash = (37 * hash) + CCLJBEJHFOP_FIELD_NUMBER;
      hash = (53 * hash) + getCCLJBEJHFOP().hashCode();
      hash = (37 * hash) + LKCFGDBHHIL_FIELD_NUMBER;
      hash = (53 * hash) + getLKCFGDBHHIL();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.PlayerLoginReqOuterClass.PlayerLoginReq buildPartial() {
        ...
        result.mADLMMNJICA_ = mADLMMNJICA_;
        result.cCLJBEJHFOP_ = cCLJBEJHFOP_;
        result.lKCFGDBHHIL_ = lKCFGDBHHIL_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.PlayerLoginReqOuterClass.PlayerLoginReq other) {
        ...
        if (!other.getMADLMMNJICA().isEmpty()) {
          mADLMMNJICA_ = other.mADLMMNJICA_;
          onChanged();
        }
        if (!other.getCCLJBEJHFOP().isEmpty()) {
          cCLJBEJHFOP_ = other.cCLJBEJHFOP_;
          onChanged();
        }
        if (other.getLKCFGDBHHIL() != 0) {
          setLKCFGDBHHIL(other.getLKCFGDBHHIL());
        }
  ...
  checkByteStringIsUtf8(value);
      ...
      private java.lang.Object mADLMMNJICA_ = "";
      /**
       * <code>string MADLMMNJICA = 135;</code>
       * @return The mADLMMNJICA.
       */
      ...
      /**
       * <code>string MADLMMNJICA = 135;</code>
       * @param value The mADLMMNJICA to set.
       * @return This builder for chaining.
       */
      public Builder setMADLMMNJICA(
          java.lang.String value) {
        if (value == null) {
    throw new NullPointerException();
  }
       ...
       * @return This builder for chaining.
       */
      public Builder clearMADLMMNJICA() {
        
        mADLMMNJICA_ = getDefaultInstance().getMADLMMNJICA();
        onChanged();
        return this;
      }
      /**
       * <code>string MADLMMNJICA = 135;</code>
       * @param value The bytes for mADLMMNJICA to set.
       * @return This builder for chaining.
       */
      public Builder setMADLMMNJICABytes(
          com.google.protobuf.ByteString value) {
        if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
      ...
      private java.lang.Object cCLJBEJHFOP_ = "";
      /**
       * <code>string CCLJBEJHFOP = 745;</code>
       * @return The cCLJBEJHFOP.
       */
      ...
      /**
       * <code>string CCLJBEJHFOP = 745;</code>
       * @param value The cCLJBEJHFOP to set.
       * @return This builder for chaining.
       */
      public Builder setCCLJBEJHFOP(
          java.lang.String value) {
        if (value == null) {
    throw new NullPointerException();
  }
       ...
       * @return This builder for chaining.
       */
      public Builder clearCCLJBEJHFOP() {
        
        cCLJBEJHFOP_ = getDefaultInstance().getCCLJBEJHFOP();
        onChanged();
        return this;
      }
      /**
       * <code>string CCLJBEJHFOP = 745;</code>
       * @param value The bytes for cCLJBEJHFOP to set.
       * @return This builder for chaining.
       */
      public Builder setCCLJBEJHFOPBytes(
          com.google.protobuf.ByteString value) {
        if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
      ...
      /**
       * <code>uint32 LKCFGDBHHIL = 1881;</code>
       * @param value The lKCFGDBHHIL to set.
       * @return This builder for chaining.
       */
      public Builder setLKCFGDBHHIL(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearLKCFGDBHHIL() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "fo.proto\032\024TrackingIOInfo.proto\"\363\007\n\016Playe" +
      ...
      "\021\n\010birthday\030\256\001 \001(\t\022\024\n\013MADLMMNJICA\030\207\001 \001(\t" +
      "\022\024\n\013CCLJBEJHFOP\030\351\005 \001(\t\022\024\n\013LKCFGDBHHIL\030\331\016" +
    ...
    internal_static_PlayerLoginReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_PlayerLoginReq_descriptor,
        new java.lang.String[] { "Token", "ClientVersion", "SystemVersion", "DeviceName", "DeviceUuid", "TargetUid", "LoginRand", "IsEditor", "LanguageType", "AccountType", "AccountUid", "Platform", "DeviceInfo", "PlatformType", "IsGuest", "CloudClientIp", "GmUid", "Checksum", "OnlineId", "ClientToken", "SecurityCmdReply", "ExtraBinData", "Cps", "ChannelId", "SubChannelId", "ChecksumClientVersion", "Tag", "TrackingIoInfo", "CountryCode", "ClientDataVersion", "EnvironmentErrorCode", "TargetHomeOwnerUid", "PsnId", "ClientVerisonHash", "IsTransfer", "RegPlatform", "TargetHomeParam", "AdjustTrackingInfo", "Birthday", "MADLMMNJICA", "CCLJBEJHFOP", "LKCFGDBHHIL", });
    emu.grasscutter.net.proto.AdjustTrackingInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.TrackingIOInfoOuterClass.getDescriptor();
  }
