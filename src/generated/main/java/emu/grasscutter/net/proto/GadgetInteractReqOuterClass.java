...
public final class GadgetInteractReqOuterClass {
  ...
  public interface GadgetInteractReqOrBuilder extends
    ...
    /**
     * <code>uint32 GCIEIJIOADO = 12;</code>
     * @return The gCIEIJIOADO.
     */
    int getGCIEIJIOADO();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int GCIEIJIOADO_FIELD_NUMBER = 12;
    private int gCIEIJIOADO_;
    /**
     * <code>uint32 GCIEIJIOADO = 12;</code>
     * @return The gCIEIJIOADO.
     */
    @java.lang.Override
    public int getGCIEIJIOADO() {
      return gCIEIJIOADO_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (gCIEIJIOADO_ != 0) {
        output.writeUInt32(12, gCIEIJIOADO_);
      }
      if (gadgetId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (gCIEIJIOADO_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(12, gCIEIJIOADO_);
      }
      if (gadgetId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getGCIEIJIOADO()
          != other.getGCIEIJIOADO()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + GCIEIJIOADO_FIELD_NUMBER;
      hash = (53 * hash) + getGCIEIJIOADO();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.GadgetInteractReqOuterClass.GadgetInteractReq buildPartial() {
        ...
        result.gCIEIJIOADO_ = gCIEIJIOADO_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.GadgetInteractReqOuterClass.GadgetInteractReq other) {
        ...
        if (other.getGCIEIJIOADO() != 0) {
          setGCIEIJIOADO(other.getGCIEIJIOADO());
        }
      ...
      /**
       * <code>uint32 GCIEIJIOADO = 12;</code>
       * @param value The gCIEIJIOADO to set.
       * @return This builder for chaining.
       */
      public Builder setGCIEIJIOADO(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearGCIEIJIOADO() {
  ...
  static {
    ...
    internal_static_GadgetInteractReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GadgetInteractReq_descriptor,
        new java.lang.String[] { "GadgetEntityId", "OpType", "GadgetId", "IsUseCondenseResin", "ResinCostType", "GCIEIJIOADO", });
    emu.grasscutter.net.proto.InterOpTypeOuterClass.getDescriptor();
    emu.grasscutter.net.proto.ResinCostTypeOuterClass.getDescriptor();
  }
